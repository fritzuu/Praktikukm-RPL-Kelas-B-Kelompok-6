                ...
                <div className="flex items-center gap-4 ml-auto">
                    ...
                    <div className="relative" ref={notifRef}>
                        <button
                            ...
                            className="relative p-2 rounded-lg text-text-secondary hover:bg-surface hover:text-text-primary transition-colors group"
                        >
                            ...
                            {unreadCount > 0 && (
                                <motion.span
                                    ...
                                    className="absolute top-1 right-1 w-4 h-4 bg-danger text-white text-[9px] font-bold rounded-full flex items-center justify-center"
                                >
                                    {unreadCount}
                                </motion.span>
                            )}
