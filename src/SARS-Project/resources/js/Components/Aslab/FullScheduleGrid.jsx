                        ...
                        return (
                            <div key={room.id} className="grid grid-cols-[140px_repeat(11,_minmax(0,_1fr))] border-b border-border last:border-b-0 relative group">
                                ...
                                <div className="col-span-11 grid grid-cols-11 relative py-3 min-h-[100px] gap-y-3">
                                    ...
                                    {/* Render Classes — no isOwn highlight for aslab */}
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex items-start justify-between gap-1 mb-1">
                                                    <span className="font-black text-[10px] leading-none uppercase tracking-tighter text-primary-600">
                                                        {item.kode}
                                                    </span>
                                                    {isConflict && (
                                                ...
                                                <p className="text-[10px] mt-1.5 font-medium italic text-text-muted opacity-80">
                                                    {item.dosen}
                                                </p>
                                            </div>
                                        );
