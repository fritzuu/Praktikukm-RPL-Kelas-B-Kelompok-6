...
import { X, Bot, Sparkles, Send, ClipboardCheck, Clock } from 'lucide-react';
import {
            ...
            <div className="flex-1 overflow-y-auto panel-scroll px-4 py-4 space-y-5">
                    ...
                    <div className="bg-surface rounded-xl p-3.5">
                        ...
                        <div className="mt-3 bg-warning/10 border border-warning/20 rounded-lg px-3 py-2.5">
                            ...
                            <p className="text-xs text-text-primary leading-relaxed">
                                {MOCK_ASLAB_AI_ANALYSIS.rekomendasi}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="bg-surface rounded-xl p-3 text-center">
                            <div className="flex items-center justify-center gap-1.5 mb-1">
                                <ClipboardCheck size={12} className="text-text-muted" />
                                <span className="text-[10px] text-text-muted">
                                    Validasi Minggu Ini
                                </span>
                            </div>
                            <p className="text-2xl font-bold text-text-primary">
                                {MOCK_ASLAB_METRIK.validasiMingguIni}
                            </p>
                        </div>
                        <div className="bg-surface rounded-xl p-3 text-center">
                            <div className="flex items-center justify-center gap-1.5 mb-1">
                            ...
                            <p className="text-2xl font-bold text-text-primary">
                                {MOCK_ASLAB_METRIK.rataRataWaktuRespon}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        {MOCK_ASLAB_TUGAS.map((tugas, idx) => (
