...
export default function AdminJadwal({
    ...
    const handleFileSelect = (file) => {
        ...
        if (['.txt', '.csv'].includes(extension)) {
            ...
            alert('Silakan upload file teks (.txt) atau (.csv) yang berisi format teks jadwal.');
        }
    };
            ...
            <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-text-secondary mt-1 text-sm">
                        Lihat ketersediaan ruangan, filter matkul, atau import jadwal semester baru.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs font-semibold text-text-primary">
                                            {uploadedFileName ? uploadedFileName : 'Upload File Teks (.txt / .csv)'}
                                        </p>
                                ...
                                <div className="bg-surface/30 border border-border/50 rounded-xl p-4 flex flex-col justify-center gap-1.5">
                                    ...
                                    <p className="text-[10px] leading-relaxed text-text-muted">
                                        Format input menggunakan teks berstruktur sesi per hari. Sistem akan mem-parsing otomatis ruangan, kelas, semester, dan mendeteksi bentrok jam kuliah.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                {errors.raw_text && (
                                    <span className="text-[10px] text-rose-500 font-semibold">{errors.raw_text}</span>
                                )}
                            </div>
                            ...
                            <div className="flex items-center gap-3 bg-rose-500/5 border border-rose-500/10 p-3 rounded-xl">
                                ...
                                />
                                <label htmlFor="overwrite-schedules" className="text-xs font-semibold text-rose-700 cursor-pointer select-none">
                                    Hapus semua jadwal & kelas lama sebelum melakukan import baru
                                </label>
                            </div>
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                ...
                                >
                                    {processing ? 'Sedang Memproses...' : 'Impor & Simpan Jadwal'}
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm space-y-4">
                            ...
                            <div className="text-xs space-y-3 leading-relaxed text-text-muted">
                                <p>Pastikan format teks jadwal Anda mengikuti aturan penulisan berikut agar berhasil terbaca:</p>
                                
                                <div className="space-y-2 pt-1">
                                    <div className="p-2.5 bg-surface rounded-lg border border-border font-mono text-[10px] space-y-1">
                                        <div className="text-primary-500 font-bold">📅 [Nama Hari]</div>
                                        <div>Sesi [mulai]-[akhir]: [Nama Matkul] (semester [N]) (kelas [A/B/C]) (Ruang: [Nama Ruangan])</div>
                                    </div>
                                </div>

                                <ul className="list-disc pl-4 space-y-1.5 pt-1">
                                    <li>Hari diawali dengan icon 📅 atau cukup nama hari saja (Contoh: <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">📅 Senin</code>).</li>
                                    <li>Format Sesi menggunakan angka jam kuliah (Contoh: <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">Sesi 1-3</code> atau <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">Sesi 1-2</code>).</li>
                                    <li>Informasi semester ditulis dalam kurung (Contoh: <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">(semester 2)</code>).</li>
                                    <li>Informasi kelas ditulis dalam kurung (Contoh: <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">(kelas B)</code>).</li>
                                    <li>Ruangan ditulis di paling akhir baris dengan format <code className="bg-surface px-1 py-0.5 rounded font-mono text-[10px]">(Ruang: B4-10)</code>.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
