...
export default function AdminSetting({ user }) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-card border border-border rounded-3xl p-6 text-center shadow-sm">
                        ...
                        <p className="text-text-muted text-[10px] font-black uppercase tracking-widest mt-1">Admin Fakultas</p>
...
AdminSetting.layout = (page) => <AdminLayout>{page}</AdminLayout>;
